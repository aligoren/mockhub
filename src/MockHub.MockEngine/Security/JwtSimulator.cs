...
namespace MockHub.MockEngine.Security;

public class JwtSimulator
{
    private const string DefaultSecret = "MockHub-Default-Secret-Key-For-Testing-Only-32bytes!";
    private const string DefaultIssuer = "MockHub";
    private const string DefaultAudience = "MockHubClient";
