...
using MockHub.Infrastructure;
using MockHub.Infrastructure.Data;
using MockHub.MockEngine.Middleware;
using MockHub.Web.Components;
using MockHub.Web.Services;
using Serilog;
...
try
{
    ...
    {
        var db = scope.ServiceProvider.GetRequiredService<MockHubDbContext>();
        db.Database.Migrate();
    }
    ...
    app.UseMockRouting<MockHubDbContext>();
    ...
    // SignalR hub
    app.MapHub<MockHub.Web.Hubs.MockHubSignalR>("/mockhub");
