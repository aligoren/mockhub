// MockHub Theme and Sidebar Management
...
(function() {
    ...
    window.toggleSidebar = function(e) {
        ...
        var current = localStorage.getItem('mockhub-sidebar') || 'expanded';
        var next = current === 'collapsed' ? 'expanded' : 'collapsed';
        localStorage.setItem('mockhub-sidebar', next);
    ...
    window.toggleTheme = function(e) {
        ...
        var current = localStorage.getItem('mockhub-theme') || 'dark';
        var next = current === 'light' ? 'dark' : 'light';
        localStorage.setItem('mockhub-theme', next);
    ...
    // ===== INITIALIZATION =====
    function init() {
        var isCollapsed = localStorage.getItem('mockhub-sidebar') === 'collapsed';
        var isLight = localStorage.getItem('mockhub-theme') === 'light';
